...
{
    public class CreateCriticalFactorHandler : ICommandHandler<CreateCriticalFactorRequest, Result<CreateScheduleResponse>>
    {
        ...
        public async Task<Result<CreateScheduleResponse>> Handle(CreateCriticalFactorRequest command, CancellationToken cancellationToken)
        {
